...
teams = [
    ...
    TeamInfo(1610612739, "CLE", "Cleveland Cavaliers",
             "Cavaliers", "Cleveland"),
    ...
    TeamInfo(1610612750, "MIN", "Minnesota Timberwolves",
             "Timberwolves", "Minnesota"),
    TeamInfo(1610612740, "NOP", "New Orleans Pelicans",
             "Pelicans", "New Orleans"),
    TeamInfo(1610612752, "NYK", "New York Knicks", "Knicks", "New York"),
    TeamInfo(1610612760, "OKC", "Oklahoma City Thunder",
    ...
    TeamInfo(1610612757, "POR", "Portland Trail Blazers",
